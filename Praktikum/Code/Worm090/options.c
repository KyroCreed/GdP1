...
//
enum ResCodes readCommandLineOptions(struct game_options* somegops, int argc, char* argv[]) {
    signed char c;
    ...
    // The argument is supposed to be the filename of the level to start with
    if (argc == 1) {
